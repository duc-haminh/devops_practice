...
os.environ['TRAIN_PATH'] = '~/hmd_project/devops_practice/Data/ML_basic/train.csv'
os.environ['TEST_PATH'] = '~/hmd_project/devops_practice/Data/ML_basic/test.csv'
...
output_path = os.path.expanduser('images')
